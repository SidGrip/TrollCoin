...
* [`Node`](node.h) — used by GUI to start & stop the node. Added in [#10244](https://github.com/bitcoin/bitcoin/pull/10244).
...
The interfaces above define boundaries between major components of the code (node, wallet, and gui), making it possible for them to run in [different processes](../../doc/design/multiprocess.md), and be tested, developed, and understood independently. These interfaces are not currently designed to be stable or to be used externally.
