...
const std::string EXAMPLE_ADDRESS[2] = {"TtGwdjstaz1jsYRxATAoMW95hRJXh6pju8", "TosxduwXrPSDFjYk9kiVqCyMVDhvRpkYga"};
...
{
    std::string result = "> trollcoin-cli -named " + methodname;
