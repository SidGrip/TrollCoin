...
static const char* qt_argv = "trollcoin-qt";
...
int GuiMain(int argc, char* argv[])
{
    ...
    // Window-manager / dock identity: show a clean "TrollCoin" label instead of
    // Qt's auto-derived reverse-DNS app id (org.trollcoin.trollcoin-qt).
    QApplication::setDesktopFileName(QAPP_ORG_NAME);
