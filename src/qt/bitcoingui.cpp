...
void BitcoinGUI::createActions()
{
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed TrollCoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed TrollCoin Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a trollcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible TrollCoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to TrollCoin network.", "", count);
    } else {
        //: A substring of the tooltip.
