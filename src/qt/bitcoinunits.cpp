...
{
    switch (unit) {
    case Unit::BTC: return QString("TROLL");
    case Unit::mBTC: return QString("mTROLL");
    case Unit::uBTC: return QString::fromUtf8("μTROLL");
...
{
    switch (unit) {
    case Unit::BTC: return QString("TrollCoins");
    case Unit::mBTC: return QString("Milli-TrollCoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-TrollCoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
