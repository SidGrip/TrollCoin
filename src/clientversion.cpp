 ...
 * for both trollcoind and trollcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
// TrollCoin 3.0 -- the legacy TrollCoin chain rebased onto Blackcoin More (Bitcoin Core 26.2).
// The network user agent advertised is "/Trolloshi:3.0/" (built in strSubVersion, init.cpp).
const std::string CLIENT_NAME("Trolloshi");
...
//! git will put "#define GIT_COMMIT_ID ..." on the next line inside archives. $Format:%n#define GIT_COMMIT_ID "%H"$
    ...
    #define BUILD_SUFFIX ""
#else
    #define BUILD_DESC "v3.0"   // TrollCoin 3.0 (on the Bitcoin Core 26.2 / Blackcoin More base)
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    */
    ...
    std::string strCopyrightHolders =
        ...
        "\n" + strPrefix + "The TrollCoin developers";
    return strCopyrightHolders;
}

std::string LicenseInfo()
{
    const std::string URL_SOURCE_CODE = "<https://github.com/TrollCoin2/TrollCoin-2.0>";
    ...
    return strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers").translated, COPYRIGHT_YEAR) +
           ...
           "\n" +
           _("Copyright (C) 2015-2026 The TrollCoin Developers").translated +
           "\n" +
           "\n" +
