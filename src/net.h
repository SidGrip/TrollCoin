...
/** Maximum length of incoming protocol messages. Must exceed MAX_BLOCK_SERIALIZED_SIZE
 *  (7 MB) so that full-size TrollCoin blocks can be relayed; a 4 MB cap would silently
 *  drop any 4-7 MB block at the P2P layer and partition the network. */
