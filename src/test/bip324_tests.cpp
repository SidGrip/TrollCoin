...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    // BIP324 key derivation includes network magic in its HKDF salt. The upstream
    // CSV fixes the inputs, while the expected outputs below are pinned to TrollCoin
    // mainnet magic by the independently replayed reference-vector gate.
    ...
    TestBIP324PacketVector(
        ...
        "",
        false,
        "4ebb8cfb10b01ab4e6e0c3a71841baeb",
        "71588a816dcfb2872bda77ed9e4318b8",
        "a6772149f2f16d2c52d97846c06148215ddcdde5a0d22a4e7627bf035006fc7c",
        "e0c9729bd4cee68319b45f72829076406e5319c7c1",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "3f9359a47b0e14e5f53b006787983a2f",
        "e4fea1f334786755cf2d44ab7fe1def1",
        "09d5691026f303bafa90ccfb7278dc3c1ac79483fd931a88ea7cf7644e8b774b",
        "ccfef6302ff9634a130724ceadac36172381f32f27e115f168228a0639fb5df67e9b303ce1",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "2873b99a87b4a36ffd2a5002bce538f8",
        "76435e58e7d3e41ca2868ef2a51605c6",
        "953cdacaf3383c999b6b61f0cac3d4c95ce64082e1d32384430adfcfa19bb137",
        "e8ff30dcc0141872499df93c8605e4369dda35a6e1e45abaf32bea102375b4750f37ca7badb4beec58701970b40ca5683f81f60f419a57798519d75a56d11ebfce80116eb2844797d56f38b620a5ed2487a303",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "e7cd9098ac1797d289e106cd35b4962e",
        "78af519f225d6c299d507b42ce5db5c1",
        "b90c362b63207ec838116ca3ad26c900b1c016968b56efc104138a14ed90de3e",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "7f790df26109e1a43cff847faaee261e",
        "59ed832bfffd027513dd15d62e172464",
        "6305d2228171607e8ee32c8e0a3464be5361858d86c6ab4afc4725f787f057ff",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "9ebd35c4b71b4805659f106dc053b08b",
        "d44feb526a3439ca63f4cf7d6fd2521b",
        "6e9f9ccd782291e47f129bb2e0fa630db11a6945ebf04a317739ee714c06d068",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "1c807fa340d662f297c5b3212e40890e",
        "1e200da1523de20a01e07168d6cefeda",
        "bd61aa4dba94fe60e9ce29027f7caee99f3bc592d8a0c8e4a7c81237bd23e755",
        "",
        "");
}

BOOST_AUTO_TEST_CASE(session_id_network_domain_separation)
{
    const auto key_data = ParseHex(
        "61062ea5071d800bbfd59e2e8b53d47d194b095ae5a4df04936b49772ef0d4d7");
    const auto ours_data = ParseHex<std::byte>(
    ...
    const auto theirs_data = ParseHex<std::byte>(
    ...
    const auto mainnet_session_id = ParseHex<std::byte>("a6772149f2f16d2c52d97846c06148215ddcdde5a0d22a4e7627bf035006fc7c");
    const auto testnet_session_id = ParseHex<std::byte>("098ef583c11503673936a2678f57416e6e8bcc6cbe368079feb11d4c261ef46a");
    const auto regtest_session_id = ParseHex<std::byte>("756f3089620742f7ebfbf4e2d9d40bea20dbc7f76be1ed9aac21e50796f7562c");

    CKey key;
    key.Set(key_data.begin(), key_data.end(), true);
    BOOST_REQUIRE(key.IsValid());

    const EllSwiftPubKey ours{ours_data};
    const EllSwiftPubKey theirs{theirs_data};

    SelectParams(ChainType::MAIN);
    BIP324Cipher mainnet_cipher{key, ours};
    mainnet_cipher.Initialize(theirs, true);
    BOOST_CHECK(Span{mainnet_session_id} == mainnet_cipher.GetSessionID());

    SelectParams(ChainType::TESTNET);
    BIP324Cipher testnet_cipher{key, ours};
    testnet_cipher.Initialize(theirs, true);
    BOOST_CHECK(Span{testnet_session_id} == testnet_cipher.GetSessionID());

    SelectParams(ChainType::REGTEST);
    BIP324Cipher regtest_cipher{key, ours};
    regtest_cipher.Initialize(theirs, true);
    BOOST_CHECK(Span{regtest_session_id} == regtest_cipher.GetSessionID());

    BOOST_CHECK(!(mainnet_cipher.GetSessionID() == testnet_cipher.GetSessionID()));
    BOOST_CHECK(!(mainnet_cipher.GetSessionID() == regtest_cipher.GetSessionID()));
    BOOST_CHECK(!(testnet_cipher.GetSessionID() == regtest_cipher.GetSessionID()));
