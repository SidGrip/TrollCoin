...
// These are the inherited Bitcoin keys and addresses re-encoded with
// TrollCoin's base58 prefixes. The private keys are unchanged, so the
// derived pubkeys and the deterministic signatures below still hold.
...
static const std::string addr1 = "TxZepX9Dvz9K1zVwvFscKUqLK2Li4uvrLJ";
static const std::string addr2 = "ToPn4PkGDWfNyEWbnqgNakbyaZEDCPmFwE";
static const std::string addr1C = "Tw77qyYtpHm9doVcvDS6HrbEPpRV1vK4Tp";
static const std::string addr2C = "TkjY1TeMs77LxtNEx6skGcwcDfTQPwsHbj";
