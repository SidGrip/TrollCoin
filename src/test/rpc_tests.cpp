...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    // This is the inherited Bitcoin fixture with a uint32 nTime spliced in after
    // nVersion, because TrollCoin carries nTime on every transaction. Nothing else
    // changed, so it is 197 bytes rather than upstream's 193.
    std::string rawtx = "";
...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    // The inherited Bitcoin keys re-encoded with TrollCoin's SECRET_KEY prefix (153).
    // The secrets themselves are unchanged, so they still match the two pubkeys in
    // the redeemScript above. The P2SH address is left alone: TrollCoin's
    // SCRIPT_ADDRESS is 5 as well, so it already encodes the right hash.
    std::string privkey1 = "\"PhNJGdpe7MzVk1yxLuBormmHNAjC2NmgBPP7gHtTMfveYS9D3VRV\"";
    std::string privkey2 = "\"PgCPx7MPhJLPRcyHysTV6E5ePNkoHmqhLzjajNumcms5mYJySduV\"";
...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> trollcoin-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> trollcoin-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> trollcoin-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> trollcoin-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> trollcoin-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> trollcoin-cli -named test name='[\"bar\",false,1]'\n");
