...
By default, TrollCoin allows up to 125 connections to different peers, 18 of
which are outbound. You can therefore, have at most 107 inbound connections.
Of the 18 outbound peers, there can be 16 full-relay connections and 2
...
Disabling listening will result in fewer nodes connected (remember the maximum of 18
...
limits are tiny. Keep in mind that TrollCoin's trustless model works best if you are
