# Bootstrappable TrollCoin Builds

This directory contains the files necessary to perform bootstrappable TrollCoin
builds.
...
To build TrollCoin reproducibly with all default options, invoke the
...
existing non-codesigned outputs.
...
Guix build outputs are attested to in a `guix.sigs` repository.
