...
BITCOIND=${BITCOIND:-$BINDIR/trollcoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/trollcoin.conf}
...
then
  ...
  echo -e "To safely generate a trollcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example trollcoin.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-trollcoin-conf.sh.
##
...
# parse the output from trollcoind --help
