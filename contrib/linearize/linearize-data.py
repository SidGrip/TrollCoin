...
def calc_hash_str(blk_hdr):
    # TrollCoin block identity hash is scrypt(N=1024,r=1,p=1) over the 80-byte header, not sha256d.
    blk_hdr_hash = hashlib.scrypt(blk_hdr, salt=blk_hdr, n=1024, r=1, p=1, dklen=32)
